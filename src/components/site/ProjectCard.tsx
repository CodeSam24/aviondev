    ...
    >
      ...
      <div className="absolute inset-x-6 top-16 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-3 pt-4">
          <div className="h-14 rounded-lg bg-foreground/10" />
          <div className="h-14 rounded-lg bg-foreground/[0.07]" />
          <div className="h-14 rounded-lg bg-foreground/[0.05]" />
        </div>
      </div>
...
export function ProjectCard({ project, index }: { project: Project; index: number }) {
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 px-1 pb-1 pt-6 sm:flex-row sm:items-end sm:justify-between">
